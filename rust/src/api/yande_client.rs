...
pub async fn get_posts(tags: Vec<String>, limit: u32, page: u32) -> anyhow::Result<Vec<Post>> {
    YANDE_CLIENT.get_posts(tags, limit, page).await
}

pub async fn get_similar(post_id: i64) -> anyhow::Result<crate::yande::model::Similar> {
