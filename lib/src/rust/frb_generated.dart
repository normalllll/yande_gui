...
abstract class RustLibApi extends BaseApi {
  ...
  Future<Similar> crateApiYandeClientYandeClientGetSimilar({required YandeClient that, required PlatformInt64 postId});

  YandeClient crateApiYandeClientYandeClientNew({StringArray3? ips, required bool forLargeFile});

  String crateApiRustcRustcVersion();

  RustArcIncrementStrongCountFnType get rust_arc_increment_strong_count_YandeClient;

  RustArcDecrementStrongCountFnType get rust_arc_decrement_strong_count_YandeClient;
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_Auto_Ref_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerYandeClient(that, serializer);
          sse_encode_String(url, serializer);
          sse_encode_String(filePath, serializer);
          sse_encode_u_32(maxTaskCount, serializer);
          sse_encode_DartFn_Inputs_usize_usize_Output_unit_AnyhowException(progressCallback, serializer);
        ...
        argValues: [that, url, filePath, maxTaskCount, progressCallback],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiYandeClientYandeClientDownloadToFileConstMeta => const TaskConstMeta(
    debugName: "YandeClient_download_to_file",
    argNames: ["that", "url", "filePath", "maxTaskCount", "progressCallback"],
  );
  ...
  TaskConstMeta get kCrateApiYandeClientYandeClientDownloadToMemoryConstMeta =>
      const TaskConstMeta(debugName: "YandeClient_download_to_memory", argNames: ["that", "url", "progressCallback"]);
  ...
  Future<List<Post>> crateApiYandeClientYandeClientGetPosts({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(decodeSuccessData: sse_decode_list_post, decodeErrorData: sse_decode_AnyhowException),
  ...
  TaskConstMeta get kCrateApiYandeClientYandeClientGetPostsConstMeta =>
      const TaskConstMeta(debugName: "YandeClient_get_posts", argNames: ["that", "tags", "limit", "page"]);
  ...
  Future<Similar> crateApiYandeClientYandeClientGetSimilar({required YandeClient that, required PlatformInt64 postId}) {
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(decodeSuccessData: sse_decode_similar, decodeErrorData: sse_decode_AnyhowException),
  ...
  TaskConstMeta get kCrateApiYandeClientYandeClientGetSimilarConstMeta =>
      const TaskConstMeta(debugName: "YandeClient_get_similar", argNames: ["that", "postId"]);
  ...
  YandeClient crateApiYandeClientYandeClientNew({StringArray3? ips, required bool forLargeFile}) {
    return handler.executeSync(
      SyncTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerYandeClient,
  ...
  TaskConstMeta get kCrateApiYandeClientYandeClientNewConstMeta =>
      const TaskConstMeta(debugName: "YandeClient_new", argNames: ["ips", "forLargeFile"]);
  ...
  TaskConstMeta get kCrateApiRustcRustcVersionConstMeta => const TaskConstMeta(debugName: "rustc_version", argNames: []);

  Future<void> Function(int, dynamic, dynamic) encode_DartFn_Inputs_usize_usize_Output_unit_AnyhowException(
  ...
  RustArcIncrementStrongCountFnType get rust_arc_increment_strong_count_YandeClient =>
      wire.rust_arc_increment_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerYandeClient;

  RustArcDecrementStrongCountFnType get rust_arc_decrement_strong_count_YandeClient =>
      wire.rust_arc_decrement_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerYandeClient;
  ...
  Post dco_decode_post(dynamic raw) {
    ...
    if (arr.length != 37) throw Exception('unexpected arr length: expect 37 but see ${arr.length}');
    return Post(
      ...
      sampleUrl: dco_decode_opt_String(arr[19]),
  ...
  Similar dco_decode_similar(dynamic raw) {
    ...
    return Similar(posts: dco_decode_list_post(arr[0]), source: dco_decode_post(arr[1]));
  }
  ...
  @protected
  YandeClient sse_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerYandeClient(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return YandeClientImpl.frbInternalSseDecode(sse_decode_usize(deserializer), sse_decode_i_32(deserializer));
  }
  ...
  Post sse_decode_post(SseDeserializer deserializer) {
    ...
    var var_sampleUrl = sse_decode_opt_String(deserializer);
  ...
  void sse_encode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerYandeClient(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize((self as YandeClientImpl).frbInternalSseEncode(move: true), serializer);
  }
  ...
  void sse_encode_Auto_Ref_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerYandeClient(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize((self as YandeClientImpl).frbInternalSseEncode(move: false), serializer);
  }
  ...
  void sse_encode_DartFn_Inputs_usize_usize_Output_unit_AnyhowException(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_DartOpaque(encode_DartFn_Inputs_usize_usize_Output_unit_AnyhowException(self), serializer);
  }
  ...
  void sse_encode_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerYandeClient(YandeClient self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize((self as YandeClientImpl).frbInternalSseEncode(move: null), serializer);
  }
  ...
  void sse_encode_post(Post self, SseSerializer serializer) {
    ...
    sse_encode_opt_String(self.sampleUrl, serializer);
...
class YandeClientImpl extends RustOpaque implements YandeClient {
  ...
  YandeClientImpl.frbInternalDcoDecode(List<dynamic> wire) : super.frbInternalDcoDecode(wire, _kStaticData);
  ...
  static final _kStaticData = RustArcStaticData(
    rustArcIncrementStrongCount: RustLib.instance.api.rust_arc_increment_strong_count_YandeClient,
    rustArcDecrementStrongCount: RustLib.instance.api.rust_arc_decrement_strong_count_YandeClient,
    rustArcDecrementStrongCountPtr: RustLib.instance.api.rust_arc_decrement_strong_count_YandeClientPtr,
  );
  ...
  Future<Uint8List> downloadToMemory({required String url, required FutureOr<void> Function(BigInt, BigInt) progressCallback}) =>
      RustLib.instance.api.crateApiYandeClientYandeClientDownloadToMemory(that: this, url: url, progressCallback: progressCallback);

  Future<List<Post>> getPosts({required List<String> tags, required int limit, required int page}) =>
      RustLib.instance.api.crateApiYandeClientYandeClientGetPosts(that: this, tags: tags, limit: limit, page: page);

  Future<Similar> getSimilar({required PlatformInt64 postId}) =>
      RustLib.instance.api.crateApiYandeClientYandeClientGetSimilar(that: this, postId: postId);
}
