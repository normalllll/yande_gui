...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => -284376866;
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<void> downloadToFile(
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        ...
        sse_encode_DartFn_Inputs_usize_usize_Output_unit(
      ...
      constMeta: kDownloadToFileConstMeta,
  ...
  TaskConstMeta get kDownloadToFileConstMeta => const TaskConstMeta(
  ...
  Future<Uint8List> downloadToMemory(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kDownloadToMemoryConstMeta,
  ...
  TaskConstMeta get kDownloadToMemoryConstMeta => const TaskConstMeta(
  ...
  TaskConstMeta get kGetPostsConstMeta => const TaskConstMeta(
        debugName: "get_posts",
  ...
  Future<Similar> getSimilar({required int postId, dynamic hint}) {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kGetSimilarConstMeta,
      argValues: [postId],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kGetSimilarConstMeta => const TaskConstMeta(
        debugName: "get_similar",
        argNames: ["postId"],
      );

  Future<void> Function(int, dynamic, dynamic)
      encode_DartFn_Inputs_usize_usize_Output_unit(
  ...
  FutureOr<void> Function(int, int)
      dco_decode_DartFn_Inputs_usize_usize_Output_unit(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
  ...
  @protected
  void sse_encode_DartFn_Inputs_usize_usize_Output_unit(
      FutureOr<void> Function(int, int) self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_DartOpaque(
        encode_DartFn_Inputs_usize_usize_Output_unit(self), serializer);
  }
